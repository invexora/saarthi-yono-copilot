...
> **🎬 Fast-Paced Demo Video (No Audio):** [`saarthi_demo_presentation_fast.mp4`](saarthi_demo_presentation_fast.mp4)
...
| :---: | :---: |
| [![Opportunity Nudge](screenshots/01_priya_solution_opportunity_nudge_trace.png)](screenshots/01_priya_solution_opportunity_nudge_trace.png) | [![Explainability](screenshots/02_priya_solution_explainability_governance.png)](screenshots/02_priya_solution_explainability_governance.png) |
...
| :---: | :---: |
| [![Direct Tax](screenshots/03_priya_solution_branch_friction_direct_tax.png)](screenshots/03_priya_solution_branch_friction_direct_tax.png) | [![Life Event](screenshots/04_priya_solution_life_event_recurring_deposit.png)](screenshots/04_priya_solution_life_event_recurring_deposit.png) |
...
| :---: | :---: |
| [![Stress Mode](screenshots/05_priya_solution_financial_stress_support_override.png)](screenshots/05_priya_solution_financial_stress_support_override.png) | [![Token Auth](screenshots/06_priya_solution_single_use_token_authorization.png)](screenshots/06_priya_solution_single_use_token_authorization.png) |
...
| :---: | :---: |
| [![Nudge Budget](screenshots/07_priya_solution_dynamic_nudge_budget_fatigue.png)](screenshots/07_priya_solution_dynamic_nudge_budget_fatigue.png) | [![DPDP Center](screenshots/08_priya_solution_dpdp_privacy_consent_erasure.png)](screenshots/08_priya_solution_dpdp_privacy_consent_erasure.png) |
| **Tamper-Evident SHA-256 HMAC Audit Trail** | **3D SBI Card Elite & Revolving Debt Optimizer** |
| [![HMAC Audit](screenshots/09_priya_solution_tamper_evident_merkle_audit.png)](screenshots/09_priya_solution_tamper_evident_merkle_audit.png) | [![Card Optimizer](screenshots/10_priya_solution_cards_debt_optimizer.png)](screenshots/10_priya_solution_cards_debt_optimizer.png) |
...
| :---: | :---: |
| ![MPIN Login](screenshots/01_login_mpin_keypad.png) | ![Username Login](screenshots/02_login_username_gboard.png) |
| **Banking Dashboard (Magenta Wave Card)** | **Account Details & Profile Modal** |
| ![Banking](screenshots/03_dashboard_banking_card.png) | ![Profile](screenshots/11_profile_account_details_modal.png) |
